...
import network.scanner.MainController;
import network.scanner.Configuration;
import network.scanner.IPAddress;
...
public class MainWindow extends JFrame implements ActionListener, Observer {
	...
	private void showLicence() {
		String owner = "Copyright (C) 2015  Swen Kalski";
